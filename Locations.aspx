<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Locations.aspx.cs" Inherits="EnAbleIndiaAssets.Locations" %>
    ...
    <form id="form1" runat="server">
        <div runat="server" class="form-group" style="background-color:aliceblue;width:450px;height:250px;text-align:center;margin-top:10%;margin-left:30%; border-radius:5px;">
            <div runat="server" class="pt-5 mt-3">
                <asp:Label CssClass="input-group-sm mx-2" ID="Label1" runat="server" Text="Location Name: "></asp:Label>
